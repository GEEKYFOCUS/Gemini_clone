...
// function PreviousItem({ content }) {
//   const { userMessage, feedback } = content;
//   console.log(userMessage, feedback);
//   return (
//     <>
//       <ReactMarkdown
...
function PreviousItem({ content }) {
  ...
  return (
    <div className="space-y-4"> {/* Stack all content vertically in one column */}
      <ReactMarkdown
        remarkPlugins={[remarkGfm]}
      ...
      <div className="space-y-2"> {/* Stack SVG/label and feedback vertically */}
